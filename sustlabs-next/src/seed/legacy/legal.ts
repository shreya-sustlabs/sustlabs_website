/**
 * The legal copy, lifted verbatim out of the two page components where it was
 * written inline. Seed input only — after the first seed these documents are
 * edited in the admin panel.
 *
 * Note: the privacy page renders BOTH its own sections and a second block of
 * app terms-of-service sections. That looks like an old copy-paste, but it is
 * published legal text, so it is migrated exactly as it stands today rather
...
export const PRIVACY_APP_TERMS_SECTIONS: readonly LegalSection[] = [
  {
