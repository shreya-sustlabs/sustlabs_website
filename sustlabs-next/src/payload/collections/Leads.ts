    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'text',
          label: 'Ad group',
          admin: { readOnly: true, description: 'The utm_adgroup tag.' },
        },
        {
          name: 'utmCreative',
          type: 'text',
          label: 'Creative',
          admin: { readOnly: true, description: 'The utm_creative tag — which ad was clicked.' },
        },
        {
          name: 'utmKeyword',
          type: 'text',
          label: 'Keyword',
          admin: { readOnly: true, description: 'The utm_keyword tag — the search term matched.' },
        },
        {
          name: 'utmDevice',
          type: 'text',
          label: 'Device',
          admin: { readOnly: true, description: 'The utm_device tag — m, t or c.' },
        },
        {
          name: 'utmPlacement',
          type: 'text',
          label: 'Placement',
          admin: { readOnly: true, description: 'The utm_placement tag — where the ad was shown.' },
        },
      ],
    },
  ],
