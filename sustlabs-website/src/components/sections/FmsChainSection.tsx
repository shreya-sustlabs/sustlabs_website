...
function FmsChainSectionComponent({ section, videoSrc }: FmsChainSectionProps) {
  return (
    <section className="fms-chain" aria-labelledby="fms-chain-title">
      <div className="fms-chain__inner">
        ...
        <figure className="fms-chain__frame">
          <video aria-label={section.mediaAlt} autoPlay loop muted playsInline preload="metadata" src={videoSrc} />
        </figure>
